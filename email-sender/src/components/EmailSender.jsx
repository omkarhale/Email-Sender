...
function EmailSender() {
  ...
  return (
    <div className="w-full min-h-screen flex justify-center items-center">
      <div className="email_card md:w-1/2 w-full mx-4 md:mx-0 bg-white dark:bg-gray-700 dark:text-white dark:border-none  -mt-15  p-4 rounded-lg border shadow">
        <h1 className=" text-gray-900 dark:text-gray-200 text-3xl">
          Email Sender
        </h1>
        <p className="text-gray-700 dark:text-gray-300">
          {" "}
          Send mail to your favorite person with your own app..
          <form action=" " onSubmit={handleSubmit}>
            ...
            <div className="form_field mt-4">
              ...
              <Editor
                ...
                apiKey="kw33n08bz0jtzvzso0lvehgbif1gd7spg3gh3lt8kwfymsb3"
                init={{
                  plugins: [
